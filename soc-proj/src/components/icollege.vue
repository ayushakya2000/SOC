    ...
    <div>
      ...
      >
        ...
        <v-layout row wrap class="mt-5" justify-space-between v-show="showc">
          <v-flex xs12>
            <div class=" my-5">
              <div class="text-lg-left mx-5 px-2 mt-4 border1 white--text display-1">
                <v-icon class="mb-1" dark large>assessment</v-icon>
             <h1 id="name1" class="display-3 font-weight-bold"></h1>
              </div>
              <v-flex class="mt-5">
        ...
        <v-layout class=" pt-5" justify-center v-show="showc">
          <v-flex xs8 md6 >
            <v-hover>
              <v-card
                class="rounded-card"
              ...
              >
                <v-card-title primary-title>
                  <div>
                    <h3 class="headline mb-0" id="name"></h3>
                  </div>
                </v-card-title>
                <v-card-text>
                  <div>
                  ...
                  <v-layout justify-center class="mb-4">
                    <v-dialog max-width="600">
                      <v-btn flat color="orange" slot="activator">
                        <v-chip label outline color="red">RANK</v-chip>V/S
                        ...
                        <v-card-text>
                          <div>
                            ...
                            <table style="width:100%">
                              <tr>
                                <th text align="left">Category</th>
                                <th text align="left">Opening Rank</th>
                                <th text align="left">Closing Rank</th>
                              </tr>
                              <tr>
                                <td id="0.0"></td>
                                <td id="0.1"></td>
  ...
  created() {
    ...
    newID.get().then(function(doc) {
      ...
      docr.get().then(function(doc) {
        ...
        for (var i = 0; i <= 9; i++) {
          if (branch[i]) document.getElementById("b" + i).innerHTML = branch[i];
        ...
        for (i = 0; i <= 9; i++) {
          ...
          for (j = 0, k = 0; j <= 42, k <= 14; j = j + 3, k++) {
            if (b[k]) {
              var c = b[k].split(",");
              document.getElementById(i + "." + j).innerHTML = c[0];
              document.getElementById(i + "." + (j + 1)).innerHTML = c[1];
              document.getElementById(i + "." + (j + 2)).innerHTML = c[2];
            } else {
              document.getElementById(i + "." + j).style.display = "none";
              document.getElementById(i + "." + (j + 1)).style.display = "none";
              document.getElementById(i + "." + (j + 2)).style.display = "none";
            }
          }
        }
      });
